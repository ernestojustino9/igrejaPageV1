...
const features = [
  { icon: Church, title: "Gerencie sua Igreja", desc: "Cadastre e organize todas as informações da sua comunidade." },
  { icon: Users, title: "Conecte Membros", desc: "Mantenha contato com todos os fiéis da sua congregação." },
  { icon: Heart, title: "Fortaleça a Fé", desc: "Ferramentas para aproximar sua igreja da comunidade." },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroImage} alt="Interior de igreja com luz dourada" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 text-center px-4 max-w-3xl">
          ...
          >
            ...
            <p className="text-lg md:text-xl font-body text-primary-foreground/80 max-w-xl mx-auto">
              Uma plataforma para pastores registrarem e gerenciarem suas igrejas com simplicidade e fé.
            </p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0 }}
      ...
      {/* Registration Form */}
      <section id="cadastro" className="py-16 px-4 bg-muted/30">
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground font-body">
                Preencha os dados abaixo para registrar sua igreja
              </p>
            </div>
      ...
      <footer className="py-8 px-4 border-t border-border">
        <div className="max-w-5xl mx-auto text-center">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <span className="font-display font-semibold text-foreground">IgrejaOnline</span>
          </div>
